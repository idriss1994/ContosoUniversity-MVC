...
namespace ContosoUniversity_MVC.Migrations
{
    ...
    [Migration("20230116175448_ComplexDataModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContosoUniversity_MVC.Models.CourseAssignment", b =>
                {
                    b.Property<int>("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContosoUniversity_MVC.Models.Department", b =>
                {
                    b.Property<int>("DepartmentID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ContosoUniversity_MVC.Models.Course", b =>
                {
                    b.HasOne("ContosoUniversity_MVC.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ContosoUniversity_MVC.Models.CourseAssignment", b =>
                {
                    ...
                    b.HasOne("ContosoUniversity_MVC.Models.Instructor", "Instructor")
                        .WithMany("CourseAssignments")
            ...
            modelBuilder.Entity("ContosoUniversity_MVC.Models.Department", b =>
                {
                    b.HasOne("ContosoUniversity_MVC.Models.Instructor", "Administrator")
                        .WithMany()
                        .HasForeignKey("InstructorID");
            ...
            modelBuilder.Entity("ContosoUniversity_MVC.Models.OfficeAssignment", b =>
                {
                    b.HasOne("ContosoUniversity_MVC.Models.Instructor", "Instructor")
                        ...
                        .HasForeignKey("ContosoUniversity_MVC.Models.OfficeAssignment", "InstructorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
