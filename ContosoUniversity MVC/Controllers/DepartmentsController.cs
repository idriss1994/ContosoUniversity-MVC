...
namespace ContosoUniversity_MVC.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            FillAministratorSelectList(_context);
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("DepartmentID,Name,Budget,StartDate,RowVersion,InstructorID")] Department department)
        {
            ...
            FillAministratorSelectList(_context, department.InstructorID);
            return View(department);
        }
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            if (departmentToUpdate is null)
            {
                ...
                FillAministratorSelectList(_context, deletedDepartment.InstructorID);
            ...
            FillAministratorSelectList(_context, departmentToUpdate.InstructorID);
        ...
        public async Task<IActionResult> Delete(int? id, bool? concurrencyError)
        {
            ...
            // In case it was modified previously
            if (concurrencyError.GetValueOrDefault())
            {
        ...
        private void FillAministratorSelectList(SchoolContext context, int? selectedAminstartorID = null)
        {
            ViewData["InstructorID"] = new SelectList(context.Instructors, "ID", "FullName", selectedAminstartorID);
